<template>
  <div class="flex flex-col p-5 gap-4 h-full">
      ...
      <div class="flex items-center gap-2">
          <select v-model="training_center_id" @change="getStats" class="rounded-lg text-gray-800" :disabled="$store.state.user.ut_id.description == 'TC Staff'">
  ...
  <div class="flex-auto flex flex-col">
    ...
    <b class="text-2xl font-thin">{{ data_statistics ? data_statistics.total_pending : '-' }}</b>
      ...
      <div>
          ...
          <div>
              <FullCalendar :options="calendarOptions" class="bg-white p-4 h-auto max-h-96 rounded-md animate__slideInUp"/>
          </div>
